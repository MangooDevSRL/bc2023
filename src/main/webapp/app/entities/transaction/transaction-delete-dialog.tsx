...
export const TransactionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bootcamp2023App.transaction.delete.question">
        <Translate contentKey="bootcamp2023App.transaction.delete.question" interpolate={{ id: transactionEntity.id }}>
