...
/**
 * REST controller for managing {@link com.mangoodev.bootcamp2023.domain.Client}.
 */
@RestController
@RequestMapping("/api")
public class ClientResource {
    ...
    public ResponseEntity<List<ClientDTO>> getTop3ClientsWithTransactions() {
        log.debug("REST request to get top 3 clients with transactions");
        List<ClientDTO> top3Clients = clientService.findTop3ClientsWithTransactions();
        return ResponseEntity.ok().body(top3Clients);
    }
